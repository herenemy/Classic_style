...
/* harmony export */ });
/* harmony import */ var _validateNumInput__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./validateNumInput */ "./src/js/modules/validateNumInput.js");
...
const changeModalState = state => {
  ...
  (0,_validateNumInput__WEBPACK_IMPORTED_MODULE_0__["default"])(windowWidth);
  (0,_validateNumInput__WEBPACK_IMPORTED_MODULE_0__["default"])(windowHeight);
  ...
  //   function emptyInputValidation(elem, type) {
...
const forms = state => {
  ...
  (0,_validateNumInput__WEBPACK_IMPORTED_MODULE_0__["default"])(document.querySelectorAll('input[name="user_phone"]'));
  const message = {
    loading: "Загрузка...",
...
const modals = state => {
  function bindModal(triggerSelector, modalSelector, closeSelector, isClickedOverlay = true, objLength, modalContent) {
  ...
  bindModal(".popup_calc_button", ".popup_calc_profile", ".popup_calc_profile .popup_calc_profile_close", false, 3, ".popup_calc_content");
  bindModal(".popup_calc_profile_button", ".popup_calc_end", ".popup_calc_end .popup_calc_end_close", false, 4, ".popup_calc_profile_content");
...
/***/ "./src/js/modules/validateNumInput.js":
/*!********************************************!*\
  !*** ./src/js/modules/validateNumInput.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (validateNumInput);
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  let modalState = {};
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_5__["default"])(".container1", "2025-10-10");
